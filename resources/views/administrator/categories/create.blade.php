	                        ...
	                        <div class="form-group">
		                		...
		                		<div class="col-md-12">
			                        <label class="checkbox checkbox-custom">
		                              <input name="format" type="radio" value="news" checked="checked"><i></i> Tin tức
		                          </label>
			                        <label class="checkbox checkbox-custom">
		                              <input name="format" type="radio" value="product"><i></i> Sản phẩm
		                          </label>
			                        <label class="checkbox checkbox-custom">
		                              <input name="format" type="radio" value="project"><i></i> Dự án
		                          </label>
			                        <label class="checkbox checkbox-custom">
		                              <input name="format" type="radio" value="partner"><i></i> Đối tác - khách hàng
		                          </label>
