	...
	<div class="page">
		...
		<section class="tile">
	        ...
	        <div class="tile-header dvd dvd-btm">
	            <h1 class="custom-font"><strong>Product</strong> show</h1>
	            <ul class="controls">
	                <li>
	        ...
	        <div class="tile-body">
			    ...
			    <div class="col-md-6 col-md-offset-3">
				    <a href="{{ route('admin.product.index') }}" class="btn btn-success">Hoàn thành</a>
				    <a href="{{ route('admin.product.edit', $product->id) }}" class="btn btn-primary">Sửa chữa</a>
			    </div>
			    <div class="clearfix"></div>
	        </div>
	        <!-- /tile body -->
