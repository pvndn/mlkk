			...
			<form action="{{ route('admin.product.store') }}" method="POST">
		        ...
		        <div class="col-md-6">
		            <section class="tile">
	                    ...
	                    <div class="form-group row col-md-12">
                              ...
                              <input type="checkbox" id="guarantee"><i></i> Bảo hành
                          </label>
		                		</div>
		                		<div class="col-md-8 input-group" id="input-guarantee">
		                			<input type="text" class="form-control" name="guarantee" placeholder="Bảo hành / tháng " value="{{ old('guarantee') }}">
	                        ...
	                        <div class="form-group">
		                        <label>Số lượng sản phẩm</label>
	                					<input type="number" class="form-control" name="numbers" placeholder="Số lượng sản phẩm" value="{{ old('number') }}" min="0">
	                        </div>

	                        <div class="form-group">
	                        	<label class="checkbox checkbox-custom-alt">
                                <input type="checkbox" name="high_light" value="1"><i></i> Nổi bật (Đánh dấu nếu chọn nổi bật sản phẩm)
                            </label>
	                        </div>
		        ...
		        <div class="col-md-6">
		            <section class="tile">
		                ...
		                <div class="tile-body">
                      <div class="form-group">
                        <label for="exampleInputSlug">Giá thị trường</label>
                        <div class="input-group {{ $errors->has('price_market') ? ' has-error' : '' }}">
                            <input type="text" class="form-control" name="price_market" placeholder="Giá bán thị trường" value="{{ old('price_market') }}">
                						<span class="input-group-btn">
		                	...
		                	<div>
		                		<label>
														Giá bán<!-- <input type="checkbox" name="sale" id="sale-price"><i></i>  -->
                        </label>
		                	</div>

		                	<div id="show-sale" class="input-group form-group">
                        <input type="text" class="form-control" name="price" placeholder="Giá bán giảm giá" value="{{ old('price') }}">
												<span class="input-group-btn">
													<button class="btn btn-default" type="button">VNĐ</button>
												</span>
			                	<!-- <div class="col-md-2">
	            					<a class="btn btn-info mb-10 btn-rounded" href="" onclick="return loadSalePrice()" data-container="body" data-toggle="popover" data-placement="top" data-content="Add different price for product." data-trigger="hover"><i class="fa fa-plus"></i>
											...
											<div class="form-group">
												<label>Thông tin khuyến mãi (thông tin khác về sản phẩm)</label>
		                ...
		                <div class="tile-body">
		                	<div class="form-group col-md-12" style="margin-top: 15px;">
		                		<div class="col-md-8 input-group">
		                			<input id="thumbnail" class="form-control" type="text" name="image" placeholder="Hình ảnh sản phẩm">
		                			<span class="input-group-btn">
		                	...
		                	<div class="form-group col-md-12">
		            				<div class="col-md-8 input-group" style="float:left;">
		            					<input id="thumbnail-photo-0" class="form-control" type="text" name="photo[]" placeholder="Hình ảnh thêm cho sản phẩm">
		                			<span class="input-group-btn">
