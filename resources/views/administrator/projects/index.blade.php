	...
	<div class="page">
		...
		<section class="tile">
	        ...
	        <div class="tile-header dvd dvd-btm">
	            <h1 class="custom-font"><strong>Các dự án thự thi</strong></h1>
	            <ul class="controls">
	                <li>
	            ...
	            <div class="table-responsive">
	                <table class="table table-custom" id="editable-usage">
	                    ...
	                    @if( $projects )
		                    ...
		                    <tr class="odd gradeX">
		                        <td><img src="{{ $p->image }}" width="75" height="50" /></td>
		                        <td><a href="{{ route('admin.project.show', $p->id) }}">{{ $p->name }}</a>
															<p>
		                        ...
		                        <td class="actions">
		                        	<form action="{{ route('admin.project.destroy', $p->id) }}" method="POST">
		                        		{{ method_field('DELETE') }}
		                        		{{ csrf_field() }}
			                        	<a href="{{ route('admin.project.edit', $p->id) }}" role="button" tabindex="0" class="edit text-primary text-uppercase text-strong text-sm mr-10">Sửa</a>
