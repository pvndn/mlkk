		        ...
		        <div class="col-md-6">
		            <section class="tile">
		                ...
		                <div class="tile-body">
	                        <div class="form-group row col-md-12">
		                		<div class="col-md-4">
			                		<label class="checkbox checkbox-custom-alt">
	                                    <input type="checkbox" id="guarantee" {{ $product->guarantee != '' ? 'checked' : '' }}><i></i> Guarantee
	                                </label>
		                		</div>
		                		<div class="col-md-8 input-group" id="input-guarantee">
		                			<input type="text" class="form-control" name="guarantee" placeholder="Guarantee " value="{{ old('guarantee', $product->guarantee != '' ? $product->guarantee : 0) }}">
	                        ...
	                        <div class="form-group">
		                        <label>Number</label>
	                			<input type="number" class="form-control" name="numbers" placeholder="number product" value="{{ old('number', $product ? $product->number : '') }}" min="0">
	                        </div>

	                        <div class="form-group">
	                        	<label class="checkbox checkbox-custom-alt">
                                    <input type="checkbox" name="high_light" value="1" {{ $product->high_light == 1 ? "checked" : '' }}><i></i> High light
                                </label>
	                        </div>
		                ...
		                <div class="tile-body">
	                        <div class="form-group">
		                        ...
		                        <div class="input-group {{ $errors->has('price_market') ? ' has-error' : '' }}">
		                            <input type="text" class="form-control" name="price_market" placeholder="Price market" value="{{ old('price_market', $product ? $product->price_market : '') }}">
		                			<span class="input-group-btn">
		                	...
		                	<div class="clearfix"></div>
		                	<div class="different-sale" id="load-sale-price" style="margin-top: 20px;">
		                		@if($product->price_different != '')
		                			<?php $id = 0; ?>
		                			@foreach($product->price_different as $price_diff)
		                				<?php $id++; ?>
		                			<div class="form-group col-md-6" id="price-{{ $id }}">
		                				<input class="form-control" type="text" name="price_different[]" placeholder="Insert different price..." value="{{ $price_diff }}">
		                				<div class="remove remove-price">
		                					<a role="button" tabindex="0" class="tile-close" onclick="return removePrice({{ $id }});"><i class="fa fa-times"></i></a>
		                				</div>
		                			</div>
		                			@endforeach
		                		@endif
