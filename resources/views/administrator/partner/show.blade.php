		...
		<section class="tile">
	        ...
	        <div class="tile-body">
	        	<div class="col-md-9 col-md-offset-1">
		        	<div class="row">
			            <div class="col-md-12 content">
			            	<div class="col-md-3">
			            		<img src="{{ asset($post->logo) }}" width="100%" />
			            	</div>
			            	<div class="col-md-9">
			            		<h3 style="margin: 0">{{ $post->name }}</h3>
							    	...
							    	<div class="clearfix"></div>
										<div class="col-md-12" style="margin: 15px 0">
											website: <a href="{{ $post->link }}">{{ $post->link }}</a>
										</div>
							    	<div class="clearfix"></div>
										<div class="desc">
											{{ $post->desc }}
			    ...
			    <div class="col-md-6 col-md-offset-3">
				    <a href="{{ route('admin.partner.index') }}" class="btn btn-success">Hoàn thành</a>
				    <a href="{{ route('admin.partner.edit', $post->id) }}" class="btn btn-primary">Sửa chữa</a>
			    </div>
			    <div class="clearfix"></div>
	        </div>
	    </section>
